...
DATABASES = {
    'default': {
        ...
        'NAME': 'mhjohnson_gk',                      # Or path to database file if using sqlite3.
        'USER': 'mhjohnson_gk',                      # Not used with sqlite3.
...
SECRET_KEY = '&bdirbg(ersc07@^0-7gltg1bv6c1ca(&c38c75t%&+4#eyz(+'
